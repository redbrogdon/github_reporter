...
interpretations. Do make sure to include the repo's name when including a section for
an issue or pull request. 

Here is an example that shows the format you should aim for:

<example>
**[Issue #50565](https://github.com/dart-lang/sdk/issues/50565) (dart-lang/sdk): ☂️ [vm/ffi] Build hooks & Code assets**
  * **Reactions:** **225** -- 👍 122 🎉 10 ❤️ 65 🚀 11 👀 17
  * Adds the ability to include native assets and binaries in Dart packages.

**[PR #178259](https://github.com/flutter/flutter/pull/178259) (flutter/flutter): impeller: makes deferred display list images trash their display lists after they are realized**
  * **Comments:** 4
...
**🔥🔥🔥 [PR #176492](https://github.com/flutter/flutter/pull/176492) (flutter/flutter): Image GIF pausing**
  * **Comments:** 11
...
**[Issue #129757](https://github.com/flutter/flutter/issues/129757) (flutter/flutter): ☂️ Build hooks & Code assets**
  * **Reactions:** **102** -- 👍 72 🎉 8 ❤️ 9 🚀 6 👀 7
  * Adds the ability use native assets from within Flutter plugins.

**🔥 [PR #177959](https://github.com/flutter/flutter/pull/177959) (flutter/flutter): Impeller: Allows R32G32B32A32_SFLOAT images**
  * **Comments:** 9
...
**[Issue #61523](https://github.com/dart-lang/sdk/issues/61523) (dart-lang/sdk): Implement ScopedThreadLocal as a mechanism to keep dart user state associated with isolate group callbacks**
